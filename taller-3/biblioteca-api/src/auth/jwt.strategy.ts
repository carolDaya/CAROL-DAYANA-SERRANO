...
export class JwtStrategy extends PassportStrategy(Strategy) {
  // Declaración de la clase JwtStrategy que extiende PassportStrategy
  constructor(
    cfg: ConfigService,
    private authSvc: AuthService,
  ) {
    // Declaración del constructor con inyección de servicios
    super({
      // Llamada al constructor de la clase padre con configuración
  ...
  async validate(payload: any) {
    // Declaración del método validate para procesar el payload
